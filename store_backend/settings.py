...
ALLOWED_HOSTS = [
        'cgsmart.in', 
        'www.cgsmart.in', 
        'my-online-store-ggbj.onrender.com', # Yahan apna Render wala exact domain zaroor check kar lein
]
...
MIDDLEWARE = [
    ...
    'whitenoise.middleware.WhiteNoiseMiddleware',  # 👈 Yeh zaroori tha (Add kar diya gaya hai)
